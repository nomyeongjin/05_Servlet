...
@WebServlet("/join") // form 태그의 action 타입과 연결되는 링크가 동일하지 않음 -> 동일하게 수정
public class JoinServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String memberName = req.getParameter("memberName"); //정확한 name 기재
		...
		String path = "/WEB-INF/views/success.jsp"; // success.jsp가 있는 정확한 경로 입력
