...
// 2) 등록된 servlet과 () 내 요청 주소 매핑 -> <servlet-napp)
@WebServlet("/ex2")
public class ExampleServlet2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String ordererName = req.getParameter("ordererName"); // 주문자
		String ordererAddress = req.getParameter("ordererAdress"); // 주소
		...
		// 선택한 치킨, 뼈/순산, 옵션에 따라 달라지는 계산 계산하기
		int price = 0;
		switch(chicken) {
